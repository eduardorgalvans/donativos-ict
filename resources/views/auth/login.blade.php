    ...
    <div class="login-reg-panel">
        ...
        <div class="white-panel">
            ...
            <div class="register-show">
                <img src="assets/img/ICT_logo.png" width="300px" alt="logo" class="">
                <hr>
                <h4 class="centro">Recuperar</h4>
                <input type="text" id="email" name="email" class="form-control form-control-lg" placeholder="Correo" required autofocus value="{{ old('email') }}">
                {{-- 
