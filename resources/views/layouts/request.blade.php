...
@elseif(session()->has('success'))
    <div class="desaparecer alert alert-success alert-dismissible fade show mb-2">
        <div class="d-flex">
...
@elseif(session()->has('danger'))
    <div class="desaparecer alert alert-danger alert-dismissible fade show mb-2">
        <div class="d-flex">
            <i class="fas fa-exclamation fa-2x me-1"></i>
            <div class="mb-0 ps-2">
                {{ session()->get('danger') }}
            </div>
        </div>
