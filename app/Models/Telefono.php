...
class Telefono extends Model
{
    ...
    protected $table = 'TblTelefonosPersonas';

    protected $primaryKey = 'IdTelefono';

    protected $fillable = ['IdPersona', 'Telefono', 'Descripcion',
        'EsTelefonoDeEmergencia', 'Estatus'
    ];

    protected static $logAttributes = ['IdPersona', 'Telefono', 'Descripcion',
        'EsTelefonoDeEmergencia', 'Estatus', 'TblU_id'
    ];
