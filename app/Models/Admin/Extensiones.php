...
class Extensiones extends Model
{
     ...
     * @var string
     */
    protected $table = "TblAdminExtenciones";
    /**
     * The attributes that are mass assignable.
     *
     * @var array
     */
    protected $fillable = ['Tipo', 'Extencion', 'TblDGP_id', 'Nombres', 'Seccion', 'Jesuita',  'Estatus', 'TblU_id', ];
     ...
     * @var array
     */
    protected static $logAttributes = ['Tipo', 'Extencion', 'TblDGP_id', 'Nombres', 'Seccion', 'Jesuita',  'Estatus', 'TblU_id', ];
