...
class Menu extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['id', 'id_Padre', 'Nombre', 'Ruta', 'Icono', 'Permiso', 'Tipo', 'Orden', 'Estatus', 'TblU_id', ];
     ...
     * @var array
     */
    protected static $logAttributes = ['id', 'id_Padre', 'Nombre', 'Ruta', 'Icono', 'Permiso', 'Tipo', 'Orden', 'Estatus', 'TblU_id', ];
