...
class MenusExport implements FromCollection, WithMapping, WithHeadings, ShouldAutoSize, WithColumnFormatting, WithEvents
{
    use Exportable;
    ...
    {
        return [
            '#', 'Padre', 'Nombre', 'Permiso', 'Orden', 'Tipo', 'Estatus',
        ];
    }
